...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if ($data && password_verify($password, $data['password'])) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'swathikutty994413@gmail.com'; //host email 
        $mail->Password = 'xxse qfrb pqbm vnbi'; // app password of your host email
        $mail->Port = 587;
        $mail->SMTPSecure = 'tls';
        $mail->isHTML(true);
        $mail->setFrom('swathikutty994413@gmail.com', 'Login System');//Sender's Email & Name
